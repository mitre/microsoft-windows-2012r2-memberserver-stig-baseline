control "V-36735" do
  ...
  software updates."
  describe "A manual review is required to esnure the system supports automated patch management tools to facilitate
  flaw remediation." do
    skip 'A manual review is required to esnure the system supports automated patch management tools to facilitate
  flaw remediation.'
  end
end
