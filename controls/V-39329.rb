...
the intruder."
  ...
  tag 'gid': 'V-39329'
  tag 'rid': 'SV-51173r2_rule'
  tag 'stig_id': 'WN12-AU-000211-DC'
  tag 'fix_id': 'F-44330r1_fix'
  ...
  tag 'check': "Verify the auditing configuration for the AdminSDHolder object.
...
If the audit settings on the AdminSDHolder object are not at least as inclusive
...
Applies to - Descendant Organizational Unit objects"
  tag 'fix': "Configure the audit settings for AdminSDHolder object to include
the following.
