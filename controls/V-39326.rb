...
the intruder."
  ...
  tag 'gid': 'V-39326'
  tag 'rid': 'SV-51170r2_rule'
  tag 'stig_id': 'WN12-AU-000208-DC'
  tag 'fix_id': 'F-44327r1_fix'
  ...
  tag 'check': "Verify the auditing configuration for the Domain object.
...
Modify owner)"
  tag 'fix': "Configure the audit settings for Domain object to include the
following.
