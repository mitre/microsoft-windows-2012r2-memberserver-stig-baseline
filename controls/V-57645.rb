control "V-57645" do
  ...
  employ encryption to protect the confidentiality and integrity of all
  information at rest."
  describe "A manual review is required to ensure that systems requiring data at rest protections employ cryptographic
  mechanisms to prevent unauthorized disclosure and modification of the
  information at rest." do
    skip 'A manual review is required to ensure that systems requiring data at rest protections employ cryptographic
  mechanisms to prevent unauthorized disclosure and modification of the
  information at rest.'
  end
end
