...
authenticate each other."
  ...
  tag 'gid': 'V-14820'
  tag 'rid': 'SV-51190r2_rule'
  tag 'stig_id': 'WN12-PK-000006-DC'
  tag 'fix_id': 'F-44347r3_fix'
  tag 'cci': ["CCI-000185"]
  ...
  tag 'ia_controls': "IAKM-1, IAKM-2, IATS-1, IATS-2"
  tag 'check': "Verify the source of the domain controller's server certificate.
...
In the right pane, examine the Issued By field for the certificate to determine
the issuing CA.

If the Issued By field of the PKI certificate being used by the domain
controller does not indicate the issuing Certificate Authority (CA) is part of
...
http://iase.disa.mil/pki-pke/function_pages/tools.html"
  tag 'fix': "Obtain PKI certificates issued by the DoD PKI or an approved
