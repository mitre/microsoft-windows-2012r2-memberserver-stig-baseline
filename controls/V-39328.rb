...
This includes the Domain Controller OU object.  Because changes to these
objects can significantly impact access controls or the availability of
systems, the absence of auditing data makes it impossible to identify the
source of changes that impact the confidentiality, integrity, and availability
of data and systems throughout an AD domain.  The lack of proper auditing can
result in insufficient forensic evidence needed to investigate an incident and
prosecute the intruder."
  impact 0.5
  tag 'severity': nil
  tag 'gtitle': 'WINAU-000210-DC'
  tag 'gid': 'V-39328'
  tag 'rid': 'SV-51172r2_rule'
  tag 'stig_id': 'WN12-AU-000210-DC'
  tag 'fix_id': 'F-44329r1_fix'
  ...
  tag 'check': "Verify the auditing configuration for the Domain Controller OU
object.

Open \"Active Directory Users and Computers\".  (Available from various menus
or run \"dsa.msc\".)
Ensure Advanced Features is selected in the View menu.
Select the Domain Controllers OU under the domain being reviewed in the left
pane.
...
Applies to - Descendant Organizational Unit objects"
  tag 'fix': "Configure the audit settings for Domain Controllers OU object to
