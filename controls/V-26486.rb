control 'V-26486' do
  ...
  if is_domain == 'WORKGROUP'
    ...
    describe security_policy do
      its('SeDenyRemoteInteractiveLogonRight') { should include "S-1-5-21-#{domain_sid}-512" }
    end
    describe security_policy do
      its('SeDenyRemoteInteractiveLogonRight') { should include "S-1-5-21-#{domain_sid}-519" }
    end
  end
end
