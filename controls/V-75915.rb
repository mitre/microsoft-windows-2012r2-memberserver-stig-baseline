control "V-75915" do
  ...
  describe "A manual review is requred to ensure orphaned security identifiers (SIDs) are removed from user rights
  on Windows 2012 / 2012 R2" do
    skip 'A manual review is requred to ensure orphaned security identifiers (SIDs) are removed from user rights
  on Windows 2012 / 2012 R2'
  end
end
