...
class WindowsRegistryResource < Inspec.resource(1)
  ...
  def readable?(by_usergroup, by_specific_user)
    ...
    if @perms_provider.nil?
      return skip_resource '`readable?` is not supported on your OS yet.'
      end
  ...
  def writable?(by_usergroup, by_specific_user)
    return false unless exist?
    if @perms_provider.nil?
      return skip_resource '`writable?` is not supported on your OS yet.'
      end
  ...
  def executable?(by_usergroup, by_specific_user)
    return false unless exist?
    if @perms_provider.nil?
      return skip_resource '`executable?` is not supported on your OS yet.'
      end
  ...
  def allowed?(permission, opts = {})
    if @perms_provider.nil?
      return skip_resource '`allowed?` is not supported on your OS yet.'
      end
  ...
  def windows_registry_permission_granted?(access_type, by_usergroup, by_specific_user)
    if @perms_provider.nil?
      raise '`windows_registry_permission_granted?` is not supported on your OS'
      end
